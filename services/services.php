      ...
      <div class="col-lg-12 m-auto">
         <div class="card">
          <div class="card-header bg-primary text-center">
            <h3 class="text-white">Service Policey Information<a href="../logout.php" class="btn btn-warning  float-right">Logout</a></h3>
      </div>
     <div class="card-body">
        <table class="table table-striped">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                 <a href="service_edit.php?id=<?= $service['id']?>" class="btn btn-secondary">Edit</a>
